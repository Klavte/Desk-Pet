...
const icons: DesktopIcon[] = [
  { id:"egosearch", label:"EgoSearcher", src:"/assets/Fromtemd/icon_desktop_egosearch.png" },
  { id:"internet",  label:"Internet",    src:"/assets/Fromtemd/icon_desktop_internet.png" },
  { id:"folder1",   label:"ドキュメント", src:"/assets/Fromtemd/icon_desktop_folder_open1.png" },
  { id:"folder2",   label:"ピクチャ",     src:"/assets/Fromtemd/icon_desktop_folder_open2.png" },
  { id:"twitter",   label:"Twitter",     src:"/assets/Fromtemd/icon_desktop_twitter.png" },
  { id:"youtube",   label:"YouTube",     src:"/assets/Fromtemd/icon_desktop_youtube2.png" },
  { id:"movie",     label:"Movies",      src:"/assets/Fromtemd/icon_desktop_movie.png" },
  { id:"text",      label:"メモ",         src:"/assets/Fromtemd/icon_desktop_text.png" },
  { id:"zip",       label:"Archive",     src:"/assets/Fromtemd/icon_desktop_folder_zip.png" },
  { id:"jine",      label:"Jine",        src:"/assets/Fromtemd/icon_desktop_jine2.png" },
...
const taskbarApps=[
  {src:"/assets/Fromtemd/icon_taskbar_jine.png",alt:"Jine"},
  {src:"/assets/Fromtemd/icon_taskbar_poketter.png",alt:"Poketter"},
  {src:"/assets/Fromtemd/icon_taskbar_taskmanager.png",alt:"TaskMgr"},
];
const trayIcons=[
  {src:"/assets/Fromtemd/icon_status_yami.png",alt:"yami"},
  {src:"/assets/Fromtemd/icon_status_follower.png",alt:"follower"},
  {src:"/assets/Fromtemd/icon_status_love.png",alt:"love"},
  {src:"/assets/Fromtemd/icon_status_stress.png",alt:"stress"},
];
const startMenuItems=[
  {src:"/assets/Fromtemd/icon_desktop_egosearch.png",label:"EgoSearcher"},
  {src:"/assets/Fromtemd/icon_desktop_internet.png", label:"Internet"},
  {src:"/assets/Fromtemd/icon_desktop_movie.png",    label:"Movies"},
  {src:"/assets/Fromtemd/icon_desktop_twitter.png",  label:"Twitter"},
  {src:"/assets/Fromtemd/icon_desktop_youtube2.png", label:"YouTube"},
  {src:"/assets/Fromtemd/icon_desktop_jine2.png",    label:"Jine"},
];
...
<template>
  <div class="desk" @click="selectedId=null;showStartMenu=false">
    ...
    <div class="tb">
      <div class="tb-l">
        <button class="tb-st" @click.stop="toggleStartMenu"><img src="/assets/Fromtemd/button_start.png" alt="Start" /></button>
...
<style scoped>
.desk { width:100%;height:100%;width:100%;position:relative;overflow:hidden;user-select:none;font-family:"zpix",sans-serif; }
...
.di.sel{background:rgba(200,100,220,0.35);border-color:rgba(220,180,240,0.5)}
...
/* start menu */
.sm{position:absolute;bottom:40px;left:0;width:230px;background:#fff;border-top:3px solid #9a60c0;z-index:100;box-shadow:2px -2px 16px rgba(0,0,0,0.3);border-radius:0 6px 0 0}
...
.tb-ap:hover{background:rgba(255,255,255,0.35)}
.tb-ap:active{border-top:1px solid rgba(0,0,0,0.3);background:rgba(0,0,0,0.06)}
.tb-ap img{width:22px;height:22px;image-rendering:pixelated}
.tb-r{display:flex;align-items:center;gap:5px;padding-right:8px;height:100%}
.tb-ti{width:16px;height:16px;image-rendering:pixelated}
.tb-ar{color:rgba(0,0,0,0.35);font-size:6px;margin-left:1px;line-height:1}
.tb-ck{color:#3a1a50;font-size:13px;letter-spacing:.5px;padding:2px 5px 0;border-radius:2px}
</style>